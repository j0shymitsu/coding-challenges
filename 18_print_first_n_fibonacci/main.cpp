...
int main()
{
    ...
    while (true)
    {
        int up_to = read_int("How many Fibonacci numbers would you like to generate? (Max 92): ");
...
std::vector<long long> print_fibonacci_to(int n)
{
    ...
    if (n < 0) throw std::invalid_argument("\033[31mCannot print up to a negative number (FUNCTION: 'print_fibonacci_to') \033[0m");

    if (n > 92) throw std::out_of_range("\033[31mMax allowed to be printed is 93 (FUNCTION: 'print_fibonacci_to')\033[0m");
