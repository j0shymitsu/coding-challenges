...
int main()
{
    ...
    while (true)
    {
        ...
        try
        {
            ...
            std::cout << "\n" << num << " in reverse is: " << reversed_num << std::endl;
        }
...
int reverse_digits(int num)
{
    ...
    if (num < 0) throw std::invalid_argument("\033[31mreverse_digits: Must be a positive number.\033[0m");
    if (num > INT_MAX) throw std::out_of_range("\033[31mreverse_digits: Number out of range (max 2147483647).\033[0m");
    ...
    if (rev_num > INT_MAX)
    {
        throw std::out_of_range("\033[31mreverse_digits: Returned number out of range (max 2147483647).\033[0m");
    }
